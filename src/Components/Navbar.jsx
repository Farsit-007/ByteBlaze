...
const Navbar = () => {
    ...
    return (
        <div>
            <div className="navbar bg-base-100 shadow-xl fixed z-10 px-16">
                <div className="flex-1">
                    <Link to='/' className="btn btn-ghost gap-0 normal-case text-secondary text-3xl font-bold">Byte<span className="text-primary">Blaze</span></Link>
                </div>
                <div className="flex-none">
                    <ul className="menu menu-horizontal px-1 text-lg hidden sm:flex gap-5 pr-5">
